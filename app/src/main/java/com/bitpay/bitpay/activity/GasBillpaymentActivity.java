...
public class GasBillpaymentActivity extends BaseActivity {
    ...
    private EditText gasProviderETV;
    private EditText editGasNumber;
    ...
    protected void initViews() {
        settingTitle(getString(R.string.menu_gas_bill_pay));
        ...
        gasProviderETV = (EditText) findViewById(R.id.gasProviderETV);
        editGasNumber = (EditText) findViewById(R.id.editGasNumber);
        ...
        FontUtils.changeFont(context, editGasNumber, FONT_ROBOTO_REGULAR);
        FontUtils.changeFont(context, gasProviderETV, FONT_ROBOTO_REGULAR);
        ...
        if (selectedConnectionProvider != null)
            gasProviderETV.setText(selectedConnectionProvider.getConnectionName());
        getCurrentBalance();
        getBitcoinRate();
    }
    ...
    protected void initContext() {
        context = GasBillpaymentActivity.this;
        currentActivity = GasBillpaymentActivity.this;
    }
    ...
    protected void initListners() {
        ...
        editGasNumber.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
    ...
    private boolean isMandatoryFields() {
        editGasNumber.setError(null);
        amountEditText.setError(null);

        if (TextUtils.isEmpty(mobileNumber)) {
            editGasNumber.setError(getString(R.string.error_enter_consumer_number));
            editGasNumber.requestFocus();
            return false;
        } /*else if (!Validator.getInstance().validateGasNumber(context, editGasNumber.getText().toString()).equals("")) {
            String numberError = Validator.getInstance().validateNumber(context, editGasNumber.getText().toString());
            editGasNumber.setError(numberError);
            editGasNumber.requestFocus();
            return false;
        }*/
    ...
    private void initRechargeModel() {
        ...
        RechargeModel.getInstance().setNumber(editGasNumber.getText().toString());
        RechargeModel.getInstance().setRechargeType(RECHARGE_GAS);
    }
    ...
    private void showAlertDialog() {
        ...
        mobileNumberTextView.setText(getString(R.string.gasNumber));
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if (response.getBoolean(RESPONCE_ERROR) || message.isEmpty()) {
                        alert(currentActivity, getString(R.string.msg_recharge_gas_failed), getString(R.string.msg_recharge_gas_failed), getResources().getString(R.string.alert_ok_button_text_no_network), getResources().getString(R.string.alert_cancel_button_text_no_network), true, true, ALERT_TYPE_NO_NETWORK);
                    } else {
                        JSONObject messageJson = new JSONObject(message);
                        ...
                        bundle.putInt(KEY_TRANSACTION_TYPE, TYPE_GAS);
