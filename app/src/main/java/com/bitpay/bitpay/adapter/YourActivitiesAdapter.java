...
public class YourActivitiesAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<ActivityModel> arrayList;
    private LayoutInflater inflater = null;

    public YourActivitiesAdapter(Context context, ArrayList<ActivityModel> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final YourActivitiesAdapter.MyViewHolder mViewHolder;
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.activity_listview_row_item, parent, false);
            mViewHolder = new YourActivitiesAdapter.MyViewHolder();
            ...
            mViewHolder = (YourActivitiesAdapter.MyViewHolder) convertView.getTag();
        }

        if (arrayList != null && arrayList.size() > position) {
            activityModel = arrayList.get(position);
        }
